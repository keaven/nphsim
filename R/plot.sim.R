plot.sim<-function(d   # data.table "result" generated by simtest function
                  ,y   # vector of the name(s) of the y varaible(s) for the boxplot. e.g. c("hr")
                  ,dg=NULL  # number of digits for median of y below the table. NULL will disable the display.
                  ,yt="Y Axis Title"  # y axis label
                  ,logs=NULL  # y axis: linear or log
                  ,b=NULL  # whether to show boundary crossing probability at each analysis. This require xeff and xfut exist in the results
                  ,v=c(2,0.5))  ## height of graph area and the summary area below.
{
  a=copy(d)
  a[,x:=factor(analysis)]
  ey=substitute(y)
